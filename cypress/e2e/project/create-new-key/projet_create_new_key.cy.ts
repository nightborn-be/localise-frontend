describe('Test project dashoboard page ', () => {
    ...
    describe('Testing create new key with sucessfull flow', () => {
    ...
    describe('Testing create new key with error flow', () => {
        it('create new key without infos', () => {
            cy.get('[data-cy="addNewRowTermButton"]').click();
